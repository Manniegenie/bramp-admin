      ...
      <Card className="p-6">
        ...
        <div className="space-y-3 text-gray-600">
          ...
          <div className="flex items-start gap-3">
            ...
            <p>Runs automatically at 7:00 AM, 12:00 PM, 6:00 PM, and 9:00 PM daily</p>
          </div>
        </div>
      </Card>

      {/* Gift Card Notifications Link */}
      <Card className="p-6 border-pink-200 bg-pink-50/50">
        <Link
          to="/scheduled-giftcard-notifications"
          className="flex items-center justify-between group"
        >
          <div className="flex items-center gap-3">
            <Gift className="w-8 h-8 text-pink-500" />
            <div>
              <h2 className="text-lg font-semibold text-gray-900 group-hover:text-pink-600 transition-colors">
                Gift Card Notifications
              </h2>
              <p className="text-sm text-gray-600">
                iTunes, Steam, Razer Gold rates at 11:00 AM and 3:00 PM
              </p>
            </div>
          </div>
